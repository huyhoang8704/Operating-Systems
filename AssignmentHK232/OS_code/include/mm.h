...
#define PAGING_FPN_MASK_v2 GENMASK(PAGING_PTE_FPN_HIBIT, PAGING_PTE_FPN_LOBIT)
#define PAGING_SWP_MASK GENMASK(PAGING_SWP_HIBIT, PAGING_SWP_LOBIT)
#define PAGING_SWAPTYPE(x) GETVAL(x, PAGING_PTE_SWPTYP_MASK, PAGING_PTE_SWPTYP_LOBIT)
...
#define PAGING_FPN_v2(x) GETVAL(x, PAGING_FPN_MASK_v2, PAGING_PTE_FPN_LOBIT)
...
/*----------------TLB--------------*/
#define TLB_FPN_LOBIT 0
#define TLB_FPN_HIBIT 12
#define TLB_FPN_MASK GENMASK(TLB_FPN_HIBIT, TLB_FPN_LOBIT)
#define GET_TLB_FPN(v) GETVAL(v, TLB_FPN_MASK, TLB_FPN_LOBIT)
#define SET_TLB_FPN(v, value) SETVAL(v, value, TLB_FPN_MASK, TLB_FPN_LOBIT)

#define TLB_PGN_LOBIT 13
#define TLB_PGN_HIBIT 26
#define TLB_PGN_MASK GENMASK(TLB_PGN_HIBIT, TLB_PGN_LOBIT)
#define GET_TLB_PGN(v) GETVAL(v, TLB_PGN_MASK, TLB_PGN_LOBIT)
#define SET_TLB_PGN(v, value) SETVAL(v, value, TLB_PGN_MASK, TLB_PGN_LOBIT)

#define TLB_PID_LOBIT 27
#define TLB_PID_HIBIT 30
#define TLB_PID_MASK GENMASK(TLB_PID_HIBIT, TLB_PID_LOBIT)
#define GET_TLB_PID(v) GETVAL(v, TLB_PID_MASK, TLB_PID_LOBIT)
#define SET_TLB_PID(v, value) SETVAL(v, value, TLB_PID_MASK, TLB_PID_LOBIT)

#define VALID_BIT_TLB_MASK BIT(31)
#define CLR_VALID_TLB(v) CLRBIT(v, VALID_BIT_TLB_MASK)
#define SET_VALID_TLB(v) SETBIT(v, VALID_BIT_TLB_MASK)
#define GET_VALID_TLB(v) GETVAL(v, VALID_BIT_TLB_MASK, 31)
